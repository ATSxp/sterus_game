...
#define OBJ_8X16  0x04
#define OBJ_8X32  0x05
#define OBJ_16X32 0x06
#define OBJ_32X64 0x07

#define OBJ_16X8  0x08
#define OBJ_32X8  0x09
#define OBJ_32X16 0x0A
#define OBJ_64X32 0x0B
